      ...
      <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
        <div className="flex flex-col justify-between col-span-12 py-2 space-y-8 md:space-y-16 md:col-span-3">
          <div className="flex flex-col space-y-8 md:space-y-12">
            <div className="flex flex-col space-y-2">
              <h3 className="flex items-center space-x-2 dark:text-coolGray-400">
                <span className="flex-shrink-0 w-2 h-2 uppercase rounded-full text-blue-600"></span>
          ...
          <div className="flex flex-col w-full space-y-2">
            <div className="flex w-full h-1 bg-opacity-10 text-blue-600">
              <div className="w-1/2 h-full text-blue-600"></div>
            </div>
            <a
              rel="noopener noreferrer"
              href="#"
            ...
            >
              ...
              <svg
                ...
                className="w-4 strokeCurrent text-blue-600"
              >
        ...
        <div
          ...
          style={{
            backgroundImage: `url("https://i.ibb.co/Ms0RCKx/outdoor-portrait-handsome-dark-haired-male-with-smartphone-hand-reading-good-news-having-nice-mood-d.webp")`,
          }}
        >
          <span className="absolute px-1 pb-2 text-xs font-bold uppercase border-b-2 left-6 top-6 text-blue-600 dark:text-coolGray-100">
            paris, france
          </span>
          <a className="flex flex-col items-center justify-end p-6 text-center sm:p-8 group dark:via-transparent flex-grow-1 bg-gradient-to-b dark:from-coolGray-900 dark:to-coolGray-900">
            <span className="flex items-center mb-4 space-x-2 text-blue-600">
              <span className="relative flex-shrink-0 w-2 h-2 rounded-full text-blue-600">
                <span className="absolute flex-shrink-0 w-3 h-3 rounded-full -left-1 -top-1 animate-ping text-blue-600"></span>
              </span>
            ...
            <h1
              rel="noopener noreferrer"
              href="#"
              className="font-serif  text-2xl font-semibold group-hover:underline dark:text-coolGray-100"
            >
        ...
        <div className="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
          <div className="mb-8 space-x-5 border-b-2 border-opacity-10 text-blue-600">
            <button
              type="button"
              className="pb-5 text-xs font-bold uppercase border-b-2 text-blue-600"
            >
              Latest
            </button>
            <button
