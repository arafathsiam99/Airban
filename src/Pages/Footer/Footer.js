...
const Footer = () => {
  ...
  return (
    <div className="pt-12">
      <footer id="footer" className="relative z-50 bg-white pt-24">
                  ...
                  <ul>
                    <li>
                      <Link href="javascript:void(0)">
                        <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-blue-700">
                          Components
                        </a>
                      </Link>
                    </li>
                    ...
                    <li className="mt-6">
                      <a
                        ...
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-blue-700"
                      >
                        Documentation
                      </a>
                    </li>
                ...
                <div className="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                  <div className="flex items-center mb-6">
                    <a href="javascript:void(0)">
                      <div className="text-blue-700 cursor-pointer hover:text-brand dark:hover:text-brand ">
                        <svg
                    ...
                    <a href="javascript:void(0)">
                      <div className="pl-4">
                        <svg
                          className="footer-icon feather feather-twitter text-blue-700 cursor-pointer hover:text-brand dark:hover:text-brand "
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
                  ...
                  <div className="relative w-36">
                    ...
                    {/* {mode == "light" && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="absolute inset-0 m-auto ml-3 text-blue-700 icon icon-tabler icon-tabler-brightness-up"
                        width={20}
                        height={20}
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
                    ...
                    {/* <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="pointer-events-none absolute inset-0 m-auto mr-3 text-blue-700 dark:text-gray-500 icon icon-tabler icon-tabler-chevron-down"
                      width={16}
                      height={16}
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
        ...
        <div className="py-16 flex flex-col justify-center items-center">
          ...
          <p className="mt-6 text-xs lg:text-sm leading-none text-gray-500">
            2022 Airban. All Rights Reserved.
          </p>
        </div>
      </footer>
    </div>
